...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-display font-bold text-surface-900 dark:text-white">Tambah Buku Baru</h1>
            <p class="text-sm text-surface-500 dark:text-surface-400 mt-0.5">Isi detail buku untuk menambahkan ke perpustakaan</p>
        </div>
    </div>

    <!-- Form Card -->
    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="card p-6 lg:p-8 space-y-6"
          x-data="{
              coverPreview: null,
              dragOver: false,
              handleFile(e) {
        ...
        <div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 items-start">
                ...
                <div @dragover.prevent="dragOver = true"
                    ...
                    <p class="text-sm font-medium text-surface-600 dark:text-surface-400">Drag & drop gambar di sini</p>
                    <p class="text-xs text-surface-400 dark:text-surface-500 mt-1">atau klik untuk memilih file (PNG, JPG, max 2MB)</p>
                </div>
                <!-- Preview -->
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      class="form-textarea @error('description') !border-rose-400 !ring-rose-400/20 @enderror"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div x-data="{
                open: false,
                search: '',
                selected: '{{ old('author_id') }}',
                selectedName: '',
                get filtered() {
                    const items = this.$refs.authorOptions?.querySelectorAll('[data-value]') || [];
                ...
                <div class="relative">
                    <button type="button" @click="open = !open"
                            class="form-input text-left flex items-center justify-between @error('author_id') !border-rose-400 !ring-rose-400/20 @enderror">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition
                        ...
                        <div x-ref="authorOptions" class="p-1">
            ...
            <div x-data="{
                open: false,
                search: '',
                selected: '{{ old('publisher_id') }}',
                selectedName: ''
            }">
                <label class="form-label">Penerbit <span class="text-rose-500">*</span></label>
                <div class="relative">
                    <button type="button" @click="open = !open"
                            class="form-input text-left flex items-center justify-between @error('publisher_id') !border-rose-400 !ring-rose-400/20 @enderror">
        ...
        <div>
            ...
            <p class="text-xs text-surface-400 dark:text-surface-500 mt-1">PDF, DOC, atau DOCX (max 10MB)</p>
        </div>
